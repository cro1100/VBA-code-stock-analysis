...
'Declare variables
Dim ws As Worksheet
Dim BeginPrice, EndPrice, SumOfVolume, LastTrade, HighestSumVolume As Integer
Dim HighestPerChange, LowestPerChange, Double
...
'Challenge option: find the highest change in price
        If HighestPriceChange <= EndPrice - BeginPrice Then
            HighestPriceChange = EndPrice - BeginPrice
        End If
